...
class HealthBar:
    ...
    def _update_health(self):
        """Update the healthbar colors according to the boss health"""
        self.number_red = self.boss.max_hp - self.boss.health
        if self.number_red >= 592:
            # Prevents going out of list length
            self.number_red = 591
    ...
    def _draw_health_bar(self):
        """Draw the healthbar and colors accordingly"""
